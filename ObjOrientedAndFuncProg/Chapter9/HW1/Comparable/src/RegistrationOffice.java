...
public class RegistrationOffice {
    ...
    public Student getAStudent() {
        ...
        switch (studentType) {
            case 1 -> student = new VocationalStudent(no, name, 2022, new Date(), major); //UpCasting
            case 2 -> {
                System.out.println("Enter minor: ");
                String minor = sc.next();
                student = new UndergraduateStudent(no, name, 2022, new Date(), major, minor); //UpCasting
            }
            case 3 -> {
                ...
                thesis = sc.next();
                student = new MasterStudent(no, name, 2022, new Date(), major, advisor, thesis); //UpCasting
            }
            case 4 -> {
                System.out.println("Enter advisor: ");
                advisor = sc.next();
                ...
                student = new PhdStudent(no, name, 2022, new Date(), major, advisor, thesis, qualifyingExamTaken); //UpCasting
            }
